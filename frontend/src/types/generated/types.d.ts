...
export type QuestionQuery = {
  ...
  question: {
    ...
    comments: Array<{
      ...
      id: number
      content: string
      user: { __typename?: 'User'; id: number; name: string; icon?: string | null }
    }>
  }
}
...
export function useUpdateQuestionMutation(
  baseOptions?: Apollo.MutationHookOptions<UpdateQuestionMutation, UpdateQuestionMutationVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions }
